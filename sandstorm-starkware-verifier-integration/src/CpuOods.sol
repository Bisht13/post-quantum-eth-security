...
contract CpuOods is MemoryMap, StarkParameters {
    ...
    */
    fallback() external {
        ...
        uint256[] memory batchInverseArray = new uint256[](
        ...
        assembly {
            ...
            := /*composition_query_responses*/ add(context, 0x9220)
            ...
            for {
                ...
                // Mask items for column #0.
                {
                    ...
                    let columnValue := mulmod(
                        mload(traceQueryResponses),
                        kMontgomeryRInv,
                        PRIME
                    )
                ...
                // Mask items for column #1.
                {
                    // Read the next element.
                    let columnValue := mulmod(
                        mload(add(traceQueryResponses, 0x20)),
                        kMontgomeryRInv,
                        PRIME
                    )
                ...
                // Mask items for column #2.
                {
                    // Read the next element.
                    let columnValue := mulmod(
                        mload(add(traceQueryResponses, 0x40)),
                        kMontgomeryRInv,
                        PRIME
                    )
                ...
                // Mask items for column #3.
                {
                    // Read the next element.
                    let columnValue := mulmod(
                        mload(add(traceQueryResponses, 0x60)),
                        kMontgomeryRInv,
                        PRIME
                    )
                ...
                // Mask items for column #4.
                {
                    // Read the next element.
                    let columnValue := mulmod(
                        mload(add(traceQueryResponses, 0x80)),
                        kMontgomeryRInv,
                        PRIME
                    )
                ...
                // Mask items for column #5.
                {
                    // Read the next element.
                    let columnValue := mulmod(
                        mload(add(traceQueryResponses, 0xa0)),
                        kMontgomeryRInv,
                        PRIME
                    )
                ...
                // Mask items for column #6.
                {
                    // Read the next element.
                    let columnValue := mulmod(
                        mload(add(traceQueryResponses, 0xc0)),
                        kMontgomeryRInv,
                        PRIME
                    )
                ...
                // Mask items for column #7.
                {
                    // Read the next element.
                    let columnValue := mulmod(
                        mload(add(traceQueryResponses, 0xe0)),
                        kMontgomeryRInv,
                        PRIME
                    )
                ...
                // Mask items for column #8.
                {
                    // Read the next element.
                    let columnValue := mulmod(
                        mload(add(traceQueryResponses, 0x100)),
                        kMontgomeryRInv,
                        PRIME
                    )
                ...
                // Mask items for column #9.
                {
                    // Read the next element.
                    let columnValue := mulmod(
                        mload(add(traceQueryResponses, 0x120)),
                        kMontgomeryRInv,
                        PRIME
                    )
...

                {
                    // Read the next element.
                    let columnValue := mulmod(
                        mload(compositionQueryResponses),
                        kMontgomeryRInv,
                        PRIME
                    )
                    ...
                    res := add(
                        ...
                        mulmod(
                            ...
                            add(
                                ...
                                sub(
                                    PRIME,
                                    /*composition_oods_values[0]*/ mload(
                                        add(context, 0x4fc0)
                                    )
                                )
                            ),
...

                {
                    // Read the next element.
                    let columnValue := mulmod(
                        mload(add(compositionQueryResponses, 0x20)),
                        kMontgomeryRInv,
                        PRIME
                    )
                    ...
                    res := add(
                        ...
                        mulmod(
                            ...
                            add(
                                ...
                                sub(
                                    PRIME,
                                    /*composition_oods_values[1]*/ mload(
                                        add(context, 0x4fe0)
                                    )
                                )
                            ),
    ...
    */
    function oodsPrepareInverses(
        ...
        assembly {
            ...
            let traceGenerator := /*trace_generator*/ mload(
                add(context, 0x2d00)
            )
            let
                PRIME
            ...
            mstore(
                add(expmodsAndPoints, 0x120),
                mulmod(
                    mload(add(expmodsAndPoints, 0x100)), // traceGenerator^14
                    mload(expmodsAndPoints), // traceGenerator^2
                    PRIME
                )
            )
            ...
            mstore(
                add(expmodsAndPoints, 0x160),
                mulmod(
                    mload(add(expmodsAndPoints, 0x140)), // traceGenerator^20
                    mload(add(expmodsAndPoints, 0x80)), // traceGenerator^6
                    PRIME
                )
            )
            ...
            mstore(
                add(expmodsAndPoints, 0x180),
                mulmod(
                    mload(add(expmodsAndPoints, 0x160)), // traceGenerator^26
                    mload(add(expmodsAndPoints, 0x20)), // traceGenerator^3
                    PRIME
                )
            )
            ...
            mstore(
                add(expmodsAndPoints, 0x1a0),
                mulmod(
                    mload(add(expmodsAndPoints, 0x180)), // traceGenerator^29
                    mload(expmodsAndPoints), // traceGenerator^2
                    PRIME
                )
            )
            ...
            mstore(
                add(expmodsAndPoints, 0x1e0),
                mulmod(
                    mload(add(expmodsAndPoints, 0x1c0)), // traceGenerator^32
                    mload(add(expmodsAndPoints, 0x120)), // traceGenerator^16
                    PRIME
                )
            )
            ...
            mstore(
                add(expmodsAndPoints, 0x200),
                mulmod(
                    mload(add(expmodsAndPoints, 0x1e0)), // traceGenerator^48
                    traceGenerator, // traceGenerator^1
                    PRIME
                )
            )
            ...
            mstore(
                add(expmodsAndPoints, 0x260),
                mulmod(
                    mload(add(expmodsAndPoints, 0x240)), // traceGenerator^60
                    mload(add(expmodsAndPoints, 0x40)), // traceGenerator^4
                    PRIME
                )
            )
            ...
            mstore(
                add(expmodsAndPoints, 0x280),
                mulmod(
                    mload(add(expmodsAndPoints, 0x260)), // traceGenerator^64
                    mulmod(
                        mload(add(expmodsAndPoints, 0x240)), // traceGenerator^60
                        traceGenerator, // traceGenerator^1
                        PRIME
            ...
            mstore(
                add(expmodsAndPoints, 0x2a0),
                mulmod(
                    mload(add(expmodsAndPoints, 0x280)), // traceGenerator^125
                    mulmod(
                        mload(add(expmodsAndPoints, 0x180)), // traceGenerator^29
                        traceGenerator, // traceGenerator^1
                        PRIME
            ...
            mstore(
                add(expmodsAndPoints, 0x2c0),
                mulmod(
                    mload(add(expmodsAndPoints, 0x2a0)), // traceGenerator^155
                    mulmod(
                        mload(add(expmodsAndPoints, 0x140)), // traceGenerator^20
                        traceGenerator, // traceGenerator^1
                        PRIME
            ...
            mstore(
                add(expmodsAndPoints, 0x2e0),
                mulmod(
                    mload(add(expmodsAndPoints, 0x2c0)), // traceGenerator^176
                    mload(add(expmodsAndPoints, 0x120)), // traceGenerator^16
                    PRIME
                )
            )
            ...
            mstore(
                add(expmodsAndPoints, 0x340),
                mulmod(
                    mload(add(expmodsAndPoints, 0x320)), // traceGenerator^357
                    mulmod(
                        mload(add(expmodsAndPoints, 0x1c0)), // traceGenerator^32
                        mload(add(expmodsAndPoints, 0x80)), // traceGenerator^6
                        PRIME
            ...
            mstore(
                add(expmodsAndPoints, 0x360),
                mulmod(
                    mload(add(expmodsAndPoints, 0x340)), // traceGenerator^395
                    mulmod(
                        mload(add(expmodsAndPoints, 0x340)), // traceGenerator^395
                        mulmod(
                            mload(add(expmodsAndPoints, 0x340)), // traceGenerator^395
            ...
            mstore(
                add(expmodsAndPoints, 0x380),
                mulmod(
                    mload(add(expmodsAndPoints, 0x360)), // traceGenerator^1216
                    mulmod(
                        mload(add(expmodsAndPoints, 0x280)), // traceGenerator^125
                        mulmod(
                            mload(add(expmodsAndPoints, 0x120)), // traceGenerator^16
            ...
            mstore(
                add(expmodsAndPoints, 0x3c0),
                mulmod(
                    mload(add(expmodsAndPoints, 0x3a0)), // traceGenerator^1678
                    mulmod(
                        mload(add(expmodsAndPoints, 0x300)), // traceGenerator^213
                        mulmod(
                            mload(add(expmodsAndPoints, 0x2a0)), // traceGenerator^155
                            traceGenerator, // traceGenerator^1
                            PRIME
            ...
            mstore(
                add(expmodsAndPoints, 0x3e0),
                mulmod(
                    mload(add(expmodsAndPoints, 0x3c0)), // traceGenerator^2047
                    mulmod(
                        mload(add(expmodsAndPoints, 0x3c0)), // traceGenerator^2047
                        mulmod(
                            mload(add(expmodsAndPoints, 0x3c0)), // traceGenerator^2047
                            mulmod(
                                mload(add(expmodsAndPoints, 0x380)), // traceGenerator^1358
                                mulmod(
                                    mload(add(expmodsAndPoints, 0x2c0)), // traceGenerator^176
                                    mload(add(expmodsAndPoints, 0x80)), // traceGenerator^6
                                    PRIME
            ...
            mstore(
                add(expmodsAndPoints, 0x400),
                mulmod(
                    mload(add(expmodsAndPoints, 0x3e0)), // traceGenerator^7681
                    mulmod(
                        mload(add(expmodsAndPoints, 0x2e0)), // traceGenerator^192
                        mulmod(
                            mload(add(expmodsAndPoints, 0x2e0)), // traceGenerator^192
                            mulmod(
                                mload(add(expmodsAndPoints, 0x280)), // traceGenerator^125
            ...
            let oodsPoint := /*oods_point*/ mload(add(context, 0x2d20))
            {
                ...
                point := mulmod(
                    point,
                    /*traceGenerator^2*/ mload(expmodsAndPoints),
                    PRIME
                )
                ...
                point := mulmod(
                    point,
                    /*traceGenerator^3*/ mload(add(expmodsAndPoints, 0x20)),
                    PRIME
                )
                ...
                point := mulmod(
                    point,
                    /*traceGenerator^4*/ mload(add(expmodsAndPoints, 0x40)),
                    PRIME
                )
                ...
                point := mulmod(
                    point,
                    /*traceGenerator^6*/ mload(add(expmodsAndPoints, 0x80)),
                    PRIME
                )
                ...
                point := mulmod(
                    point,
                    /*traceGenerator^5*/ mload(add(expmodsAndPoints, 0x60)),
                    PRIME
                )
                ...
                point := mulmod(
                    point,
                    /*traceGenerator^10*/ mload(add(expmodsAndPoints, 0xe0)),
                    PRIME
                )
                ...
                point := mulmod(
                    point,
                    /*traceGenerator^26*/ mload(add(expmodsAndPoints, 0x160)),
                    PRIME
                )
                ...
                point := mulmod(
                    point,
                    /*traceGenerator^8*/ mload(add(expmodsAndPoints, 0xc0)),
                    PRIME
                )
                ...
                point := mulmod(
                    point,
                    /*traceGenerator^31*/ mload(add(expmodsAndPoints, 0x1a0)),
                    PRIME
                )
                ...
                point := mulmod(
                    point,
                    /*traceGenerator^60*/ mload(add(expmodsAndPoints, 0x240)),
                    PRIME
                )
                ...
                point := mulmod(
                    point,
                    /*traceGenerator^7*/ mload(add(expmodsAndPoints, 0xa0)),
                    PRIME
                )
                ...
                point := mulmod(
                    point,
                    /*traceGenerator^16*/ mload(add(expmodsAndPoints, 0x120)),
                    PRIME
                )
                ...
                point := mulmod(
                    point,
                    /*traceGenerator^14*/ mload(add(expmodsAndPoints, 0x100)),
                    PRIME
                )
                ...
                point := mulmod(
                    point,
                    /*traceGenerator^29*/ mload(add(expmodsAndPoints, 0x180)),
                    PRIME
                )
                ...
                point := mulmod(
                    point,
                    /*traceGenerator^155*/ mload(add(expmodsAndPoints, 0x2a0)),
                    PRIME
                )
                ...
                point := mulmod(
                    point,
                    /*traceGenerator^125*/ mload(add(expmodsAndPoints, 0x280)),
                    PRIME
                )
                ...
                point := mulmod(
                    point,
                    /*traceGenerator^58*/ mload(add(expmodsAndPoints, 0x220)),
                    PRIME
                )
                ...
                point := mulmod(
                    point,
                    /*traceGenerator^213*/ mload(add(expmodsAndPoints, 0x300)),
                    PRIME
                )
                ...
                point := mulmod(
                    point,
                    /*traceGenerator^1216*/ mload(add(expmodsAndPoints, 0x360)),
                    PRIME
                )
                ...
                point := mulmod(
                    point,
                    /*traceGenerator^2047*/ mload(add(expmodsAndPoints, 0x3c0)),
                    PRIME
                )
                ...
                point := mulmod(
                    point,
                    /*traceGenerator^1678*/ mload(add(expmodsAndPoints, 0x3a0)),
                    PRIME
                )
                ...
                point := mulmod(
                    point,
                    /*traceGenerator^64*/ mload(add(expmodsAndPoints, 0x260)),
                    PRIME
                )
                ...
                point := mulmod(
                    point,
                    /*traceGenerator^192*/ mload(add(expmodsAndPoints, 0x2e0)),
                    PRIME
                )
                ...
                point := mulmod(
                    point,
                    /*traceGenerator^49*/ mload(add(expmodsAndPoints, 0x200)),
                    PRIME
                )
                ...
                point := mulmod(
                    point,
                    /*traceGenerator^1358*/ mload(add(expmodsAndPoints, 0x380)),
                    PRIME
                )
                ...
                point := mulmod(
                    point,
                    /*traceGenerator^176*/ mload(add(expmodsAndPoints, 0x2c0)),
                    PRIME
                )
                ...
                point := mulmod(
                    point,
                    /*traceGenerator^32*/ mload(add(expmodsAndPoints, 0x1c0)),
                    PRIME
                )
                ...
                point := mulmod(
                    point,
                    /*traceGenerator^357*/ mload(add(expmodsAndPoints, 0x320)),
                    PRIME
                )
                ...
                point := mulmod(
                    point,
                    /*traceGenerator^8191*/ mload(add(expmodsAndPoints, 0x400)),
                    PRIME
                )
                ...
                point := mulmod(
                    point,
                    /*traceGenerator^7681*/ mload(add(expmodsAndPoints, 0x3e0)),
                    PRIME
                )
                ...
                point := mulmod(
                    point,
                    /*traceGenerator^20*/ mload(add(expmodsAndPoints, 0x140)),
                    PRIME
                )
                ...
                point := mulmod(
                    point,
                    /*traceGenerator^48*/ mload(add(expmodsAndPoints, 0x1e0)),
                    PRIME
                )
                ...
                point := mulmod(
                    point,
                    /*traceGenerator^395*/ mload(add(expmodsAndPoints, 0x340)),
                    PRIME
                )
            ...
            for {
...

                {
                    ...
                    let denominator := add(
                        shiftedEvalPoint,
                        mload(add(expmodsAndPoints, 0x420))
                    )
...

                {
                    ...
                    let denominator := add(
                        shiftedEvalPoint,
                        mload(add(expmodsAndPoints, 0x440))
                    )
...

                {
                    ...
                    let denominator := add(
                        shiftedEvalPoint,
                        mload(add(expmodsAndPoints, 0x460))
                    )
...

                {
                    ...
                    let denominator := add(
                        shiftedEvalPoint,
                        mload(add(expmodsAndPoints, 0x480))
                    )
...

                {
                    ...
                    let denominator := add(
                        shiftedEvalPoint,
                        mload(add(expmodsAndPoints, 0x4a0))
                    )
...

                {
                    ...
                    let denominator := add(
                        shiftedEvalPoint,
                        mload(add(expmodsAndPoints, 0x4c0))
                    )
...

                {
                    ...
                    let denominator := add(
                        shiftedEvalPoint,
                        mload(add(expmodsAndPoints, 0x4e0))
                    )
...

                {
                    ...
                    let denominator := add(
                        shiftedEvalPoint,
                        mload(add(expmodsAndPoints, 0x500))
                    )
...

                {
                    ...
                    let denominator := add(
                        shiftedEvalPoint,
                        mload(add(expmodsAndPoints, 0x520))
                    )
...

                {
                    ...
                    let denominator := add(
                        shiftedEvalPoint,
                        mload(add(expmodsAndPoints, 0x540))
                    )
...

                {
                    ...
                    let denominator := add(
                        shiftedEvalPoint,
                        mload(add(expmodsAndPoints, 0x560))
                    )
...

                {
                    ...
                    let denominator := add(
                        shiftedEvalPoint,
                        mload(add(expmodsAndPoints, 0x580))
                    )
...

                {
                    ...
                    let denominator := add(
                        shiftedEvalPoint,
                        mload(add(expmodsAndPoints, 0x5a0))
                    )
...

                {
                    ...
                    let denominator := add(
                        shiftedEvalPoint,
                        mload(add(expmodsAndPoints, 0x5c0))
                    )
...

                {
                    ...
                    let denominator := add(
                        shiftedEvalPoint,
                        mload(add(expmodsAndPoints, 0x5e0))
                    )
...

                {
                    ...
                    let denominator := add(
                        shiftedEvalPoint,
                        mload(add(expmodsAndPoints, 0x600))
                    )
...

                {
                    ...
                    let denominator := add(
                        shiftedEvalPoint,
                        mload(add(expmodsAndPoints, 0x620))
                    )
...

                {
                    ...
                    let denominator := add(
                        shiftedEvalPoint,
                        mload(add(expmodsAndPoints, 0x640))
                    )
...

                {
                    ...
                    let denominator := add(
                        shiftedEvalPoint,
                        mload(add(expmodsAndPoints, 0x660))
                    )
...

                {
                    ...
                    let denominator := add(
                        shiftedEvalPoint,
                        mload(add(expmodsAndPoints, 0x680))
                    )
...

                {
                    ...
                    let denominator := add(
                        shiftedEvalPoint,
                        mload(add(expmodsAndPoints, 0x6a0))
                    )
...

                {
                    ...
                    let denominator := add(
                        shiftedEvalPoint,
                        mload(add(expmodsAndPoints, 0x6c0))
                    )
...

                {
                    ...
                    let denominator := add(
                        shiftedEvalPoint,
                        mload(add(expmodsAndPoints, 0x6e0))
                    )
...

                {
                    ...
                    let denominator := add(
                        shiftedEvalPoint,
                        mload(add(expmodsAndPoints, 0x700))
                    )
...

                {
                    ...
                    let denominator := add(
                        shiftedEvalPoint,
                        mload(add(expmodsAndPoints, 0x720))
                    )
...

                {
                    ...
                    let denominator := add(
                        shiftedEvalPoint,
                        mload(add(expmodsAndPoints, 0x740))
                    )
...

                {
                    ...
                    let denominator := add(
                        shiftedEvalPoint,
                        mload(add(expmodsAndPoints, 0x760))
                    )
...

                {
                    ...
                    let denominator := add(
                        shiftedEvalPoint,
                        mload(add(expmodsAndPoints, 0x780))
                    )
...

                {
                    ...
                    let denominator := add(
                        shiftedEvalPoint,
                        mload(add(expmodsAndPoints, 0x7a0))
                    )
...

                {
                    ...
                    let denominator := add(
                        shiftedEvalPoint,
                        mload(add(expmodsAndPoints, 0x7c0))
                    )
...

                {
                    ...
                    let denominator := add(
                        shiftedEvalPoint,
                        mload(add(expmodsAndPoints, 0x7e0))
                    )
...

                {
                    ...
                    let denominator := add(
                        shiftedEvalPoint,
                        mload(add(expmodsAndPoints, 0x800))
                    )
...

                {
                    ...
                    let denominator := add(
                        shiftedEvalPoint,
                        mload(add(expmodsAndPoints, 0x820))
                    )
...

                {
                    ...
                    let denominator := add(
                        shiftedEvalPoint,
                        mload(add(expmodsAndPoints, 0x840))
                    )
...

                {
                    ...
                    let denominator := add(
                        shiftedEvalPoint,
                        mload(add(expmodsAndPoints, 0x860))
                    )
...

                {
                    ...
                    let denominator := add(
                        shiftedEvalPoint,
                        mload(add(expmodsAndPoints, 0x880))
                    )
...

                {
                    ...
                    let denominator := add(
                        shiftedEvalPoint,
                        mload(add(expmodsAndPoints, 0x8a0))
                    )
...

                {
                    ...
                    let denominator := add(
                        shiftedEvalPoint,
                        mload(add(expmodsAndPoints, 0x8c0))
                    )
...

                {
                    ...
                    let denominator := add(
                        shiftedEvalPoint,
                        mload(add(expmodsAndPoints, 0x8e0))
                    )
...

                {
                    ...
                    let denominator := add(
                        shiftedEvalPoint,
                        mload(add(expmodsAndPoints, 0x900))
                    )
...

                {
                    ...
                    let denominator := add(
                        shiftedEvalPoint,
                        mload(add(expmodsAndPoints, 0x920))
                    )
...

                {
                    ...
                    let denominator := add(
                        shiftedEvalPoint,
                        mload(add(expmodsAndPoints, 0x940))
                    )
...

                {
                    ...
                    let denominator := add(
                        shiftedEvalPoint,
                        mload(add(expmodsAndPoints, 0x960))
                    )
...

                {
                    ...
                    let denominator := add(
                        shiftedEvalPoint,
                        mload(add(expmodsAndPoints, 0x980))
                    )
...

                {
                    ...
                    let denominator := add(
                        shiftedEvalPoint,
                        mload(add(expmodsAndPoints, 0x9a0))
                    )
...

                {
                    ...
                    let denominator := add(
                        shiftedEvalPoint,
                        mload(add(expmodsAndPoints, 0x9c0))
                    )
...

                {
                    ...
                    let denominator := add(
                        shiftedEvalPoint,
                        mload(add(expmodsAndPoints, 0x9e0))
                    )
...

                {
                    ...
                    let denominator := add(
                        shiftedEvalPoint,
                        mload(add(expmodsAndPoints, 0xa00))
                    )
...

                {
                    ...
                    let denominator := add(
                        shiftedEvalPoint,
                        mload(add(expmodsAndPoints, 0xa20))
                    )
...

                {
                    ...
                    let denominator := add(
                        shiftedEvalPoint,
                        mload(add(expmodsAndPoints, 0xa40))
                    )
...

                {
                    ...
                    let denominator := add(
                        shiftedEvalPoint,
                        mload(add(expmodsAndPoints, 0xa60))
                    )
...

                {
                    ...
                    let denominator := add(
                        shiftedEvalPoint,
                        mload(add(expmodsAndPoints, 0xa80))
                    )
...

                {
                    ...
                    let denominator := add(
                        shiftedEvalPoint,
                        mload(add(expmodsAndPoints, 0xaa0))
                    )
...

                {
                    ...
                    let denominator := add(
                        shiftedEvalPoint,
                        mload(add(expmodsAndPoints, 0xac0))
                    )
...

                {
                    ...
                    let denominator := add(
                        shiftedEvalPoint,
                        mload(add(expmodsAndPoints, 0xae0))
                    )
...

                {
                    ...
                    let denominator := add(
                        shiftedEvalPoint,
                        mload(add(expmodsAndPoints, 0xb00))
                    )
...

                {
                    ...
                    let denominator := add(
                        shiftedEvalPoint,
                        mload(add(expmodsAndPoints, 0xb20))
                    )
...

                {
                    ...
                    let denominator := add(
                        shiftedEvalPoint,
                        mload(add(expmodsAndPoints, 0xb40))
                    )
...

                {
                    ...
                    let denominator := add(
                        shiftedEvalPoint,
                        mload(add(expmodsAndPoints, 0xb60))
                    )
...

                {
                    ...
                    let denominator := add(
                        shiftedEvalPoint,
                        mload(add(expmodsAndPoints, 0xb80))
                    )
...

                {
                    ...
                    let denominator := add(
                        shiftedEvalPoint,
                        mload(add(expmodsAndPoints, 0xba0))
                    )
...

                {
                    ...
                    let denominator := add(
                        shiftedEvalPoint,
                        mload(add(expmodsAndPoints, 0xbc0))
                    )
...

                {
                    ...
                    let denominator := add(
                        shiftedEvalPoint,
                        mload(add(expmodsAndPoints, 0xbe0))
                    )
...

                {
                    ...
                    let denominator := add(
                        shiftedEvalPoint,
                        mload(add(expmodsAndPoints, 0xc00))
                    )
...

                {
                    ...
                    let denominator := add(
                        shiftedEvalPoint,
                        mload(add(expmodsAndPoints, 0xc20))
                    )
...

                {
                    ...
                    let denominator := add(
                        shiftedEvalPoint,
                        mload(add(expmodsAndPoints, 0xc40))
                    )
...

                {
                    ...
                    let denominator := add(
                        shiftedEvalPoint,
                        mload(add(expmodsAndPoints, 0xc60))
                    )
...

                {
                    ...
                    let denominator := add(
                        shiftedEvalPoint,
                        mload(add(expmodsAndPoints, 0xc80))
                    )
...

                {
                    ...
                    let denominator := add(
                        shiftedEvalPoint,
                        mload(add(expmodsAndPoints, 0xca0))
                    )
...

                {
                    ...
                    let denominator := add(
                        shiftedEvalPoint,
                        mload(add(expmodsAndPoints, 0xcc0))
                    )
...

                {
                    ...
                    let denominator := add(
                        shiftedEvalPoint,
                        mload(add(expmodsAndPoints, 0xce0))
                    )
...

                {
                    ...
                    let denominator := add(
                        shiftedEvalPoint,
                        mload(add(expmodsAndPoints, 0xd00))
                    )
...

                {
                    ...
                    let denominator := add(
                        shiftedEvalPoint,
                        mload(add(expmodsAndPoints, 0xd20))
                    )
...

                {
                    ...
                    let denominator := add(
                        shiftedEvalPoint,
                        mload(add(expmodsAndPoints, 0xd40))
                    )
...

                {
                    ...
                    let denominator := add(
                        shiftedEvalPoint,
                        mload(add(expmodsAndPoints, 0xd60))
                    )
...

                {
                    ...
                    let denominator := add(
                        shiftedEvalPoint,
                        mload(add(expmodsAndPoints, 0xd80))
                    )
...

                {
                    ...
                    let denominator := add(
                        shiftedEvalPoint,
                        mload(add(expmodsAndPoints, 0xda0))
                    )
...

                {
                    ...
                    let denominator := add(
                        shiftedEvalPoint,
                        mload(add(expmodsAndPoints, 0xdc0))
                    )
...

                {
                    ...
                    let denominator := add(
                        shiftedEvalPoint,
                        mload(add(expmodsAndPoints, 0xde0))
                    )
...

                {
                    ...
                    let denominator := add(
                        shiftedEvalPoint,
                        mload(add(expmodsAndPoints, 0xe00))
                    )
...

                {
                    ...
                    let denominator := add(
                        shiftedEvalPoint,
                        mload(add(expmodsAndPoints, 0xe20))
                    )
...

                {
                    ...
                    let denominator := add(
                        shiftedEvalPoint,
                        mload(add(expmodsAndPoints, 0xe40))
                    )
...

                {
                    ...
                    let denominator := add(
                        shiftedEvalPoint,
                        mload(add(expmodsAndPoints, 0xe60))
                    )
...

                {
                    ...
                    let denominator := add(
                        shiftedEvalPoint,
                        mload(add(expmodsAndPoints, 0xe80))
                    )
...

                {
                    ...
                    let denominator := add(
                        shiftedEvalPoint,
                        mload(add(expmodsAndPoints, 0xea0))
                    )
...

                {
                    ...
                    let denominator := add(
                        shiftedEvalPoint,
                        mload(add(expmodsAndPoints, 0xec0))
                    )
...

                {
                    ...
                    let denominator := add(
                        shiftedEvalPoint,
                        mload(add(expmodsAndPoints, 0xee0))
                    )
...

                {
                    ...
                    let denominator := add(
                        shiftedEvalPoint,
                        mload(add(expmodsAndPoints, 0xf00))
                    )
...

                {
                    ...
                    let denominator := add(
                        shiftedEvalPoint,
                        mload(add(expmodsAndPoints, 0xf20))
                    )
...

                {
                    ...
                    let denominator := add(
                        shiftedEvalPoint,
                        mload(add(expmodsAndPoints, 0xf40))
                    )
...

                {
                    ...
                    let denominator := add(
                        shiftedEvalPoint,
                        mload(add(expmodsAndPoints, 0xf60))
                    )
...

                {
                    ...
                    let denominator := add(
                        shiftedEvalPoint,
                        mload(add(expmodsAndPoints, 0xf80))
                    )
...

                {
                    ...
                    let denominator := add(
                        shiftedEvalPoint,
                        mload(add(expmodsAndPoints, 0xfa0))
                    )
...

                {
                    ...
                    let denominator := add(
                        shiftedEvalPoint,
                        mload(add(expmodsAndPoints, 0xfc0))
                    )
...

                {
                    ...
                    let denominator := add(
                        shiftedEvalPoint,
                        mload(add(expmodsAndPoints, 0xfe0))
                    )
...

                {
                    ...
                    let denominator := add(
                        shiftedEvalPoint,
                        mload(add(expmodsAndPoints, 0x1000))
                    )
...

                {
                    ...
                    let denominator := add(
                        shiftedEvalPoint,
                        mload(add(expmodsAndPoints, 0x1020))
                    )
...

                {
                    ...
                    let denominator := add(
                        shiftedEvalPoint,
                        mload(add(expmodsAndPoints, 0x1040))
                    )
...

                {
                    ...
                    let denominator := add(
                        shiftedEvalPoint,
                        mload(add(expmodsAndPoints, 0x1060))
                    )
...

                {
                    ...
                    let denominator := add(
                        shiftedEvalPoint,
                        mload(add(expmodsAndPoints, 0x1080))
                    )
...

                {
                    ...
                    let denominator := add(
                        shiftedEvalPoint,
                        mload(add(expmodsAndPoints, 0x10a0))
                    )
...

                {
                    ...
                    let denominator := add(
                        shiftedEvalPoint,
                        mload(add(expmodsAndPoints, 0x10c0))
                    )
...

                {
                    ...
                    let denominator := add(
                        shiftedEvalPoint,
                        mload(add(expmodsAndPoints, 0x10e0))
                    )
...

                {
                    ...
                    let denominator := add(
                        shiftedEvalPoint,
                        mload(add(expmodsAndPoints, 0x1100))
                    )
...

                {
                    ...
                    let denominator := add(
                        shiftedEvalPoint,
                        mload(add(expmodsAndPoints, 0x1120))
                    )
...

                {
                    ...
                    let denominator := add(
                        shiftedEvalPoint,
                        mload(add(expmodsAndPoints, 0x1140))
                    )
...

                {
                    ...
                    let denominator := add(
                        shiftedEvalPoint,
                        mload(add(expmodsAndPoints, 0x1160))
                    )
...

                {
                    ...
                    let denominator := add(
                        shiftedEvalPoint,
                        mload(add(expmodsAndPoints, 0x1180))
                    )
...

                {
                    ...
                    let denominator := add(
                        shiftedEvalPoint,
                        mload(add(expmodsAndPoints, 0x11a0))
                    )
...

                {
                    ...
                    let denominator := add(
                        shiftedEvalPoint,
                        mload(add(expmodsAndPoints, 0x11c0))
                    )
...

                {
                    ...
                    let denominator := add(
                        shiftedEvalPoint,
                        mload(add(expmodsAndPoints, 0x11e0))
                    )
...

                {
                    ...
                    let denominator := add(
                        shiftedEvalPoint,
                        mload(add(expmodsAndPoints, 0x1200))
                    )
...

                {
                    ...
                    let denominator := add(
                        shiftedEvalPoint,
                        mload(add(expmodsAndPoints, 0x1220))
                    )
...

                {
                    ...
                    let denominator := add(
                        shiftedEvalPoint,
                        mload(add(expmodsAndPoints, 0x1240))
                    )
...

                {
                    ...
                    let denominator := add(
                        shiftedEvalPoint,
                        mload(add(expmodsAndPoints, 0x1260))
                    )
...

                {
                    ...
                    let denominator := add(
                        shiftedEvalPoint,
                        mload(add(expmodsAndPoints, 0x1280))
                    )
...

                {
                    ...
                    let denominator := add(
                        shiftedEvalPoint,
                        mload(add(expmodsAndPoints, 0x12a0))
                    )
...

                {
                    ...
                    let denominator := add(
                        shiftedEvalPoint,
                        mload(add(expmodsAndPoints, 0x12c0))
                    )
...

                {
                    ...
                    let denominator := add(
                        shiftedEvalPoint,
                        mload(add(expmodsAndPoints, 0x12e0))
                    )
...

                {
                    ...
                    let denominator := add(
                        shiftedEvalPoint,
                        mload(add(expmodsAndPoints, 0x1300))
                    )
...

                {
                    ...
                    let denominator := add(
                        shiftedEvalPoint,
                        mload(add(expmodsAndPoints, 0x1320))
                    )
...

                {
                    ...
                    let denominator := add(
                        shiftedEvalPoint,
                        mload(add(expmodsAndPoints, 0x1340))
                    )
...

                {
                    ...
                    let denominator := add(
                        shiftedEvalPoint,
                        mload(add(expmodsAndPoints, 0x1360))
                    )
...

                {
                    ...
                    let denominator := add(
                        shiftedEvalPoint,
                        mload(add(expmodsAndPoints, 0x1380))
                    )
...

                {
                    ...
                    let denominator := add(
                        shiftedEvalPoint,
                        mload(add(expmodsAndPoints, 0x13a0))
                    )
...

                {
                    ...
                    let denominator := add(
                        shiftedEvalPoint,
                        mload(add(expmodsAndPoints, 0x13c0))
                    )
...

                {
                    ...
                    let denominator := add(
                        shiftedEvalPoint,
                        mload(add(expmodsAndPoints, 0x13e0))
                    )
...

                {
                    ...
                    let denominator := add(
                        shiftedEvalPoint,
                        mload(add(expmodsAndPoints, 0x1400))
                    )
...

                {
                    ...
                    let denominator := add(
                        shiftedEvalPoint,
                        mload(add(expmodsAndPoints, 0x1420))
                    )
...

                {
                    ...
                    let denominator := add(
                        shiftedEvalPoint,
                        mload(add(expmodsAndPoints, 0x1440))
                    )
...

                {
                    ...
                    let denominator := add(
                        shiftedEvalPoint,
                        mload(add(expmodsAndPoints, 0x1460))
                    )
...

                {
                    ...
                    let denominator := add(
                        shiftedEvalPoint,
                        mload(add(expmodsAndPoints, 0x1480))
                    )
...

                {
                    ...
                    let denominator := add(
                        shiftedEvalPoint,
                        mload(add(expmodsAndPoints, 0x14a0))
                    )
...

                {
                    ...
                    let denominator := add(
                        shiftedEvalPoint,
                        mload(add(expmodsAndPoints, 0x14c0))
                    )
...

                {
                    ...
                    let denominator := add(
                        shiftedEvalPoint,
                        mload(add(expmodsAndPoints, 0x14e0))
                    )
...

                {
                    ...
                    let denominator := add(
                        shiftedEvalPoint,
                        mload(add(expmodsAndPoints, 0x1500))
                    )
...

                {
                    ...
                    let denominator := add(
                        shiftedEvalPoint,
                        mload(add(expmodsAndPoints, 0x1520))
                    )
...

                {
                    ...
                    let denominator := add(
                        shiftedEvalPoint,
                        mload(add(expmodsAndPoints, 0x1540))
                    )
...

                {
                    ...
                    let denominator := add(
                        shiftedEvalPoint,
                        mload(add(expmodsAndPoints, 0x1560))
                    )
...

                {
                    ...
                    let denominator := add(
                        shiftedEvalPoint,
                        mload(add(expmodsAndPoints, 0x1580))
                    )
...

                {
                    ...
                    let denominator := add(
                        shiftedEvalPoint,
                        mload(add(expmodsAndPoints, 0x15a0))
                    )
...

                {
                    ...
                    let denominator := add(
                        shiftedEvalPoint,
                        mload(add(expmodsAndPoints, 0x15c0))
                    )
...

                {
                    ...
                    let denominator := add(
                        shiftedEvalPoint,
                        mload(add(expmodsAndPoints, 0x15e0))
                    )
...

                {
                    ...
                    let denominator := add(
                        shiftedEvalPoint,
                        mload(add(expmodsAndPoints, 0x1600))
                    )
...

                {
                    ...
                    let denominator := add(
                        shiftedEvalPoint,
                        mload(add(expmodsAndPoints, 0x1620))
                    )
...

                {
                    ...
                    let denominator := add(
                        shiftedEvalPoint,
                        mload(add(expmodsAndPoints, 0x1640))
                    )
...

                {
                    ...
                    let denominator := add(
                        shiftedEvalPoint,
                        mload(add(expmodsAndPoints, 0x1660))
                    )
...

                {
                    ...
                    let denominator := add(
                        shiftedEvalPoint,
                        mload(add(expmodsAndPoints, 0x1680))
                    )
...

                {
                    ...
                    let denominator := add(
                        shiftedEvalPoint,
                        mload(add(expmodsAndPoints, 0x16a0))
                    )
...

                {
                    ...
                    let denominator := add(
                        shiftedEvalPoint,
                        mload(add(expmodsAndPoints, 0x16c0))
                    )
...

                {
                    ...
                    let denominator := add(
                        shiftedEvalPoint,
                        mload(add(expmodsAndPoints, 0x16e0))
                    )
...

                {
                    ...
                    let denominator := add(
                        shiftedEvalPoint,
                        mload(add(expmodsAndPoints, 0x1700))
                    )
...

                {
                    ...
                    let denominator := add(
                        shiftedEvalPoint,
                        mload(add(expmodsAndPoints, 0x1720))
                    )
...

                {
                    ...
                    let denominator := add(
                        shiftedEvalPoint,
                        mload(add(expmodsAndPoints, 0x1740))
                    )
...

                {
                    ...
                    let denominator := add(
                        shiftedEvalPoint,
                        mload(add(expmodsAndPoints, 0x1760))
                    )
...

                {
                    ...
                    let denominator := add(
                        shiftedEvalPoint,
                        mload(add(expmodsAndPoints, 0x1780))
                    )
...

                {
                    ...
                    let denominator := add(
                        shiftedEvalPoint,
                        mload(add(expmodsAndPoints, 0x17a0))
                    )
...

                {
                    ...
                    let denominator := add(
                        shiftedEvalPoint,
                        mload(add(expmodsAndPoints, 0x17c0))
                    )
...

                {
                    ...
                    let denominator := add(
                        shiftedEvalPoint,
                        mload(add(expmodsAndPoints, 0x17e0))
                    )
...

                {
                    ...
                    let denominator := add(
                        shiftedEvalPoint,
                        mload(add(expmodsAndPoints, 0x1800))
                    )
...

                {
                    ...
                    let denominator := add(
                        shiftedEvalPoint,
                        mload(add(expmodsAndPoints, 0x1820))
                    )
...

                {
                    ...
                    let denominator := add(
                        shiftedEvalPoint,
                        mload(add(expmodsAndPoints, 0x1840))
                    )
...

                {
                    ...
                    let denominator := add(
                        shiftedEvalPoint,
                        mload(add(expmodsAndPoints, 0x1860))
                    )
...

                {
                    ...
                    let denominator := add(
                        shiftedEvalPoint,
                        mload(add(expmodsAndPoints, 0x1880))
                    )
...

                {
                    ...
                    let denominator := add(
                        shiftedEvalPoint,
                        mload(add(expmodsAndPoints, 0x18a0))
                    )
...

                {
                    ...
                    let denominator := add(
                        shiftedEvalPoint,
                        mload(add(expmodsAndPoints, 0x18c0))
                    )
...

                {
                    ...
                    let denominator := add(
                        shiftedEvalPoint,
                        mload(add(expmodsAndPoints, 0x18e0))
                    )
...

                {
                    ...
                    let denominator := add(
                        shiftedEvalPoint,
                        mload(add(expmodsAndPoints, 0x1900))
                    )
...

                {
                    ...
                    let denominator := add(
                        shiftedEvalPoint,
                        mload(add(expmodsAndPoints, 0x1920))
                    )
...

                {
                    ...
                    let denominator := add(
                        shiftedEvalPoint,
                        mload(add(expmodsAndPoints, 0x1940))
                    )
...

                {
                    ...
                    let denominator := add(
                        shiftedEvalPoint,
                        mload(add(expmodsAndPoints, 0x1960))
                    )
...

                {
                    ...
                    let denominator := add(
                        shiftedEvalPoint,
                        mload(add(expmodsAndPoints, 0x1980))
                    )
...

                {
                    ...
                    let denominator := add(
                        shiftedEvalPoint,
                        mload(add(expmodsAndPoints, 0x19a0))
                    )
...

                {
                    ...
                    let denominator := add(
                        shiftedEvalPoint,
                        mload(add(expmodsAndPoints, 0x19c0))
                    )
...

                {
                    ...
                    let denominator := add(
                        shiftedEvalPoint,
                        mload(add(expmodsAndPoints, 0x19e0))
                    )
...

                {
                    ...
                    let denominator := add(
                        shiftedEvalPoint,
                        mload(add(expmodsAndPoints, 0x1a00))
                    )
...

                {
                    ...
                    let denominator := add(
                        shiftedEvalPoint,
                        mload(add(expmodsAndPoints, 0x1a20))
                    )
...

                {
                    ...
                    let denominator := add(
                        shiftedEvalPoint,
                        mload(add(expmodsAndPoints, 0x1a40))
                    )
...

                {
                    ...
                    let denominator := add(
                        shiftedEvalPoint,
                        mload(add(expmodsAndPoints, 0x1a60))
                    )
...

                {
                    ...
                    let denominator := add(
                        shiftedEvalPoint,
                        mload(add(expmodsAndPoints, 0x1a80))
                    )
...

                {
                    ...
                    let denominator := add(
                        shiftedEvalPoint,
                        mload(add(expmodsAndPoints, 0x1aa0))
                    )
...

                {
                    ...
                    let denominator := add(
                        shiftedEvalPoint,
                        mload(add(expmodsAndPoints, 0x1ac0))
                    )
...

                {
                    ...
                    let denominator := add(
                        shiftedEvalPoint,
                        mload(add(expmodsAndPoints, 0x1ae0))
                    )
...

                {
                    ...
                    let denominator := add(
                        shiftedEvalPoint,
                        mload(add(expmodsAndPoints, 0x1b00))
                    )
...

                {
                    ...
                    let denominator := add(
                        shiftedEvalPoint,
                        mload(add(expmodsAndPoints, 0x1b20))
                    )
...

                {
                    ...
                    let denominator := add(
                        shiftedEvalPoint,
                        mload(add(expmodsAndPoints, 0x1b40))
                    )
...

                {
                    ...
                    let denominator := add(
                        shiftedEvalPoint,
                        mload(add(expmodsAndPoints, 0x1b60))
                    )
...

                {
                    ...
                    let denominator := add(
                        shiftedEvalPoint,
                        mload(add(expmodsAndPoints, 0x1b80))
                    )
...

                {
                    ...
                    let denominator := add(
                        shiftedEvalPoint,
                        mload(add(expmodsAndPoints, 0x1ba0))
                    )
...

                {
                    ...
                    let denominator := add(
                        shiftedEvalPoint,
                        mload(add(expmodsAndPoints, 0x1bc0))
                    )
...

                {
                    ...
                    let denominator := add(
                        shiftedEvalPoint,
                        mload(add(expmodsAndPoints, 0x1be0))
                    )
            ...
            for {
                ...
                prodInv := mulmod(
                    prodInv,
                    mload(
                        add(currentPartialProductPtr, productsToValuesOffset)
                    ),
                    PRIME
                )
