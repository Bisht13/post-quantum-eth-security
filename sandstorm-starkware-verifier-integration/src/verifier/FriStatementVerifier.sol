    ...
    HornerEvaluator
{
    ...
    */
    function computeLastLayerHash(
        ...
        uint256 groupOrderMinusOne = friLastLayerDegBound *
        ...
        while (friStep < nFriInnerLayers) {
            ...
            require( // NOLINT: calls-loop.
                friStatementContract.isValid(
                    keccak256(abi.encodePacked(dataToHash))
                ),
