...
import "../verifier/MerkleStatementContract.sol";
import "../verifier/FriStatementContract.sol";
import "../gps/GpsStatementVerifier.sol";
    ...
    Initializable
{
    ...
    constructor(IEntryPoint anEntryPoint) {
        merkleStatementContract = MerkleStatementContract(
            "0xe23195D7359297Be8d89F37a06240D63E527B623"
        );
        friStatementContract = FriStatementContract(
            "0x757c47a259FC8d3d4fDB53db53972C1B207976C1"
        );
        gpsStatementVerifier = GpsStatementVerifier(
            "0x7FE523743a8f002e9D64a1ccaFCDfcfA16fEb6b3"
        );
